# Contributing to KwikPaste

English | [简体中文](./CONTRIBUTING.zh-CN.md)

Thank you for helping improve KwikPaste. This guide covers the project scope,
development setup, architecture boundaries, quality checks, and contribution
expectations for code and documentation changes.

## Project Status

KwikPaste has entered its stable release line. Future changes should evolve the
...
KwikPaste supports macOS and Windows only.
...
KwikPaste uses a Rust-first Tauri architecture:
