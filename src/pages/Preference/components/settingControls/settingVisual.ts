...
const SETTING_ICON_MAP: Record<string, string> = {
  ...
  "appearance.material": "i-lucide:layers-3",
  ...
  "localData.clearHistory": "i-lucide:trash-2",
  "localData.dataDirectory": "i-lucide:folder-root",
  "localData.logDirectory": "i-lucide:folder-open-dot",
  "localData.storageLimit": "i-lucide:gauge",
  "localData.storageLimitAction": "i-lucide:shield-alert",
