...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::split_clipboard_item,
            commands::copy_clipboard_fragment,
            commands::paste_clipboard_fragment,
            ...
            commands::get_window_material_support,
        ...
        .setup(move |app| {
            ...
            window::apply_existing_window_material(&handle, &settings.appearance);
            ...
            // Windows 冷启动文件关联：第一个实例从自身启动参数里取 `.kwikpastebak` 路径。
