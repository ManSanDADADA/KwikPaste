...
const zhChangelogFile = "docs/CHANGELOG.zh-CN.md";
...
const hooks: ReleaseItHooks = {
  "after:@release-it/conventional-changelog:beforeRelease": `bash -c 'printf "\\ndocs/CHANGELOG.md has been generated. Update ${zhChangelogFile}, then press Enter to continue release-it..." > /dev/tty; IFS= read -r -s -n 1 _ < /dev/tty; printf "\\n" > /dev/tty'`,
};
